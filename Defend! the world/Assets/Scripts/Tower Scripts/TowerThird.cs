...
public class TowerThird : MonoBehaviour
{
    ...
    private void Aim()
    {
        ...
        if (Enemy != null)
        {
            ...
            tower.transform.rotation = Quaternion.Slerp(tower.transform.rotation, Quaternion.Euler(0, 0, rotation), rotateSpeed * Time.deltaTime);
            Fire();
        }
    }
